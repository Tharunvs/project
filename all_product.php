        ...
        <div class="row">
          <div ng-repeat="pro in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit" class="col-md-4">
            <div class="user-product">
              ...
              <div class="usr-product_img" ng-init="date1 = getnew(pro.added_date)"> <img ng-src="admin/upload/{{mySplit(pro.product_image,0)}}">
...
<div class="star-rating" star-rating rating-value="rating"
 ...
 data-max="10" on-rating-selected="rateFunction(rating,pro.product_id)"></div></div>
