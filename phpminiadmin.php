...
<?php if ($_SESSION['is_logged'] && $dbh){ ?>
 | <a href="">Databases</a>: <select name="db" onChange="frefresh()"><option value='*'> - select/refresh -</option><option value=''> - show all -</option>
...
<?php } ?>
 | <a href="">Settings</a>
<?php } ?>
<?php if ($GLOBALS['ACCESS_PWD']){?> | <a href="" onClick="logoff()">Logoff</a> <?php }?>
 | <a href="">phpinfo</a>
</div>
