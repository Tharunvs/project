				...
				<div class="alert alert-danger alert-dismissable" ng-show="error.length > 0">
                    ...
                    <form role="form" method="post" name="myForm" ng-submit="signupForm(form)" id="sign-up-form" novalidate autocomplete="off">
						...
						<div class="form-group">
                            ...
                            <input type="email" name="email" ng-model="form.user_email" required class="form-control" placeholder="Enter Your Address">
						...
						<div class="form-group">
                            ...
                            <input type="text" name="phone" class="form-control" ng-model="form.user_phone" required placeholder="Phone Number">
